...
import { Clock, AlertCircle, ArrowRight, ExternalLink, Database, Send, Server } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="bg-slate-950/50 px-6 py-4 border-b border-white/5">
            <h2 className="text-lg font-bold text-white">History Messages</h2>
            <p className="text-sm text-gray-500">{initialHistory.length} messages stored</p>
          </div>
          ...
          <div className="border-t border-white/5 p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-slate-950/30 rounded-xl p-4 border border-white/5">
              <div className="text-2xl font-bold text-white mb-1">{initialHistory.length}</div>
